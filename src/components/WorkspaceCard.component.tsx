import type {IUserShort, IWorkspace} from "@/models";
    ...
    return (
        <div
            ...
            <div className="flex flex-col justify-end">
                <h5 className="text-sm italic text-gray-700">Admin: {workspace?.owner?.name}</h5>
                <div className="flex justify-start gap-1">
                    <h5 className="text-sm italic text-gray-700">Members: </h5>
                    <ul>
                        {workspace.members?.map((member: IUserShort) => (
...
const WorkspaceCardMenu = ({workspace,}: WorkspaceCardMenuProps) => {
